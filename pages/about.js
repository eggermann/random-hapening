...
export const meta = {
  title: 'About HappeningRoulette.com',
  description: 'Learn more about HappeningRoulette.com and its mission.',
};
  ...
  <header className="bg-gray-800 text-white p-4 flex justify-between items-center">
    ...
    <nav>
      <ul className="flex space-x-4">
        ...
        <li><Link href="/archive" className="hover:text-gray-300">Archive</Link></li>
